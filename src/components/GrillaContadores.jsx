...
import CardContadorNavidad from './CardContadorNavidad'
import CardContadorNavidadBlack from './CardContadorNavidadBlack'
  ...
  return (
    <div  ref={container}  className='Cupon-contenedorGrilla'>
      {datos.map(contador =>(
        ...
        <CardContadorNavidad key={contador.id} contador={contador}/>
        // <CardContadorNavidadBlack key={contador.id} contador={contador}/>
      ))}
