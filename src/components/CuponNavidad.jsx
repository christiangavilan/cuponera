...
import '../styles/cuponNavidad.css'

const CuponNavidad = ({cupon}) => {
                ...
                <div className='Cupon_innerInfo'>
                  <div className='Cupon_contendorCupon'>
                    ...
                    <div className='Cupon_nombreCupon'>
                      ...
                      <img className='Cupon_iconCopiar copiarCupon' src="https://images.contentstack.io/v3/assets/blt7c5c2f2f888a7cc3/blte6f372addc0a470a/69174ac4634451980b43b834/copy-regular-full-white.png" alt="Tarjeta Oportunidad unica falabella" />
